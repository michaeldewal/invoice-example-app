...
install("session");                                                       // 58
install("jquery");                                                        // 59
install("mrt:moment");                                                    // 60
install("reactive-var");                                                  // 61
install("kadira:flow-router");                                            // 62
install("deps");                                                          // 63
install("htmljs");                                                        // 64
install("observe-sequence");                                              // 65
install("blaze");                                                         // 66
install("spacebars");                                                     // 67
install("templating");                                                    // 68
install("kadira:blaze-layout");                                           // 69
install("twbs:bootstrap");                                                // 70
install("zeroasterisk:throttle");                                         // 71
install("ui");                                                            // 72
install("space:template-controller");                                     // 73
install("standard-minifier-css");                                         // 74
install("standard-minifier-js");                                          // 75
install("rajit:bootstrap3-datepicker");                                   // 76
install("webapp");                                                        // 77
install("livedata");                                                      // 78
install("hot-code-push");                                                 // 79
install("launch-screen");                                                 // 80
